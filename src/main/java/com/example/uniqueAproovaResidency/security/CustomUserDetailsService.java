...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String identifier) throws UsernameNotFoundException {
        ...
        User user = userRepository.findByEmailOrPhone(cleanIdentifier)
                .orElseThrow(() -> new UsernameNotFoundException("User not found with mobile number or email: " + cleanIdentifier));
